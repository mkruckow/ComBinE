...
#pragma omp parallel for private(system, i, j, t2, n) firstprivate(wanted, Mp, Ms, a, e, metal, vp, vs, x, y, z, rhostar, seed, seeds, discard_mp, discard_q, discard_a, discard_kick, discard_phase, discard_eccentricity, discard_galactic, discard_rotation, phasehistory, data, dist, grid, plot) shared(count_mp, count_q, count_a, count_kick, count_phase, count_eccentricity, count_galactic, count_rotation) reduction(+ : cnotrackupdate, cRLO, cRLOA, cRLOB, cRLOBB, cCE, cCEA, cCEB, cCEBB, cMerger, cMergerRLO, cMergerCE, cMergerSN, csupernova, cNS, cBH, cplanetarynebula, cWD, cfinalunknown, ccrashed, cdestroyed, cdmerged, cdexploded, cdunknown, cfinalsingle, csborn, csmerged, csexploded, csunknown, cfinal, cWDWD, cWDNS, cWDBH, cNSWD, cNSNS, cNSBH, cBHWD, cBHNS, cBHBH, cgw, cgwWDWD, cgwWDNS, cgwWDBH, cgwNSWD, cgwNSNS, cgwNSBH, cgwBHWD, cgwBHNS, cgwBHBH)
