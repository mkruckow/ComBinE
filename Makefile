...
ComBinE: ComBinE.cpp objectfiles/tables.o objectfiles/structures.o objectfiles/setup.o objectfiles/evolution.o objectfiles/radii.o objectfiles/rotation.o objectfiles/helper.o objectfiles/tracks.o objectfiles/gravitationalwave.o objectfiles/statistics.o objectfiles/galactic.o objectfiles/user.o
...
objectfiles/rotation.o: ComBinElib/ComBinElib.h ComBinElib/rotation.cpp
	c++ $(FLAGS) -c ComBinElib/rotation.cpp -o objectfiles/rotation.o

objectfiles/helper.o: ComBinElib/ComBinElib.h ComBinElib/helper.cpp
	c++ $(FLAGS) -c ComBinElib/helper.cpp -o objectfiles/helper.o
...
profile:
	...
	c++ $(FLAGS) -pg -c ComBinElib/rotation.cpp -o objectfiles/rotation.o
	c++ $(FLAGS) -pg -c ComBinElib/helper.cpp -o objectfiles/helper.o
