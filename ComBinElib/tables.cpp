...
/*        if (stararray0[nstar0].m[stararray0[nstar0].n]>stararray0[nstar0].m[0]){
      ...
      if (((fabs(stararray0[nstar0].t[1])<accuracy)&&(stararray0[nstar0].cm[1]<=1.0e-10))||(kind==-2)){
        ...
        stararray0[nstar0].cm[0] = 1.0e-10;
...
/*      if (nstar0==0){
  ...
  //close find-file
  findfile.close();
/*  cout << "[0]: n=" << stararray0[0].n << " m[0]" << stararray0[0].m[0] << " t[0]" << stararray0[0].t[0] << " r[0]" << stararray0[0].r[0] << " core mass(cm)[0]" << stararray0[0].cm[0] << " log(lum/Lsun)(llum)[0]" << stararray0[0].llum[0] << " log(T_eff/K)(lteff)[0]" << stararray0[0].lteff[0] << " lambda[0]" << stararray0[0].lambda[0] << endl;
  cout << "[0]: n=" << stararray0[1].n << " m[1]" << stararray0[0].m[1] << " t[1]" << stararray0[0].t[1] << " r[1]" << stararray0[0].r[1] << " core mass(cm)[1]" << stararray0[0].cm[0] << " log(lum/Lsun)(llum)[1]" << stararray0[0].llum[1] << " log(T_eff/K)(lteff)[1]" << stararray0[0].lteff[1] << " lambda[1]" << stararray0[0].lambda[1] << endl;
