...
void newphase(t_system& system){
  ...
  if(isnan(system.prim.cm[system.n])||((system.prim.cm[system.n]<0)&&(system.prim.cm[system.n]!=-1.0e+99))||(system.prim.cm[system.n]>system.prim.m[system.n])){ screen = true; cerr << endl << "#prim.cm=" << system.prim.cm[system.n] << "Msun";}
  ...
  if(isnan(system.sec.cm[system.n])||((system.sec.cm[system.n]<0)&&(system.sec.cm[system.n]!=-1.0e+99))||(system.sec.cm[system.n]>system.sec.m[system.n])){ screen = true; cerr << endl << "#sec.cm=" << system.sec.cm[system.n] << "Msun";}
