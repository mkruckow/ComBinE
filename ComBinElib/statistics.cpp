...
//    if (plot) addtohist(tmerge,system.tgw,sub);
  ...
  //grid output
  if (grid){
    if ((system.phase[n]>=90)&&(system.phase[n]<=99)) gridout << i << "\t" << system.prim.m[0] << "\t" << system.sec.m[0] << "\t" << system.a[0] << "\t" << system.phase[n] << "\t" << system.prim.stage[n] << "\t" << system.sec.stage[n] << "\t" << system.prim.m[n] << "\t" << system.sec.m[n] << "\t" << system.a[n] << "\t" << system.tgw << endl;
